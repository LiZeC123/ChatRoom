...
import top.lizec.client.gui.ChatroomGUIApplication;
...
public class chatRoomClientApplication {
    ...
    public static void main(String[] args) {
        LZApplication.run(chatRoomClientApplication.class, context -> {
            ChatroomGUIApplication.setContext(context);
            ChatroomGUIApplication.launchApp();
        });
    }
}
